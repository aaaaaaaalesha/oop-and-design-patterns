...
def create_game(sprite_size, is_new):
    ...
    if is_new:
        ...
        hero.sprite = Service.create_sprite(
            os.path.join("texture", "Hero.png"), sprite_size, SE.MiniMap.tile)
        Service.service_init(sprite_size, SE.MiniMap.tile, False)
